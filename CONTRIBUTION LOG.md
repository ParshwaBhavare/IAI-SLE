# Contribution Log – Smart Irrigation AI Agent
...
I asked AI to help me create a simple Python AI agent for smart irrigation using soil moisture, temperature, humidity, rainfall, and water tank level.

### Prompt 2

I asked AI to add a decision-making system that decides whether the water pump should be ON or OFF.

### Prompt 3

I asked AI to use a score-based system where different sensor conditions increase or decrease the irrigation score.

### Prompt 4

I asked AI to calculate watering time based on soil moisture.
